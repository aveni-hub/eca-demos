...
if __name__ == '__main__':
    ...
    cell_twin_config.to_json_file("%s/%s.json" % (path_twins, cell_file))

    core_pp_config = CortexConfig(
        cortex=core_pp
    )
    core_pp_config.to_json_file("%s/core_pp.json" % path)
    ...
    server_config.to_json_file("%s/server.json" % path)
