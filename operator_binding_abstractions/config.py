...
SOURCE_ID = "opbind_src"
PAG_ID = "opbind_pag"
CORE_PP_ID = "opbind_pp"
CORE_AA_ID = "opbind_aa"
...
def twin_config() -> dict:
    return {
        ...
        "log_config": {
            "level": "info",
            "log_file": "/tmp/opbind_source.log",
            "sentry": None,
        },
        ...
        "shape": [3, 3],
        "display_name": "Operator Binding Source Stream",
        "module_id": SOURCE_ID,
        ...
        "broker_config": {
            ...
            "subscribe": "operator_binding_source_sub",
            "publish": "",
        },
        "ras_config": None,
        "in_twins": [],
...
def pag_twin_config() -> dict:
    ...
    return {
        ...
        "physical_twin_type": "sensor",
        "shape": [3, 3],
        "display_name": "Operator Binding PAG",
        "module_id": PAG_ID,
        "duration_threshold": "1s",
        "sync_rate": "250ms",
        "sync_once": False,
...
def mono_config() -> dict:
    ...
    return {
        ...
        "log_config": {
            "level": "info",
            "log_file": "/tmp/operator_binding_mono.log",
            "sentry": None,
        },
        "license_config": license_config(),
    }
...
def server_config() -> dict:
    return {
        ...
        "log_config": {
            "level": "info",
            "log_file": "/tmp/operator_binding_server.log",
            "sentry": None,
        },
        "license_config": license_config(),
    }
...
if __name__ == "__main__":
    ...
    write_json(out / "pag_twin.json", {"twin": pag_twin_config()})
    write_json(
        out / "core_pp.json",
        {
            "cortex": core_config(
